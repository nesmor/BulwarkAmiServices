  ...
  class AGI_AsteriskManager
  {
    ...
    */
    function AGI_AsteriskManager($config=NULL, $optconfig=array())
    {
      ...
      // add default values to config for uninitialized valuess
      ...
      if(!isset($this->config['asmanager']['username'])) $this->config['asmanager']['username'] = 'mark';
      if(!isset($this->config['asmanager']['secret'])) $this->config['asmanager']['secret'] = 'mysecret';
    }
